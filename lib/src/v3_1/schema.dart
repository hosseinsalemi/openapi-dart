...
import 'package:conduit_open_api/src/v3_1/types.dart';
...
class APISchemaObject extends APIObject {
  ...
  ///  If "exclusiveMaximum" is set, then a numeric instance SHOULD NOT be
  ...
  /// If "exclusiveMinimum" is set, then a numeric instance SHOULD NOT be
